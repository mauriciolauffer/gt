sap.ui.define(
  ...
  function (Controller, JSONModel) {
    ...
    return Controller.extend("chatting.controller.OfficalRightScreen", {
      onInit: function () {
        // Set Chat Model
      ...
      loadConversationHistory(conversationID) {
        const url =
          this.getBaseURL() +
          `/odata/v4/chat/Conversation(${conversationID})/to_messages`;
        var oModel = new JSONModel();
        oModel.loadData(url);
          ...
          const backendResponse = {
            ...
            initials:
              returnObj.role === "assistant"
                ? ""
                : userInfoModel.getProperty("/firstname").charAt(0) +
                  userInfoModel.getProperty("/lastname").charAt(0),
          };
