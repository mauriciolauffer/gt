...
async function getPeersVacationTimeByUserId(
  ...
  let changed_dt_startDate = dt_startDate.setDate(
    dt_startDate.getDate() - noOfDatesToExtend,
  );
  let dt_endDate = new Date(Date.parse(endDate));
  let changed_dt_endDate = dt_endDate.setDate(
    dt_endDate.getDate() + noOfDatesToExtend,
  );
